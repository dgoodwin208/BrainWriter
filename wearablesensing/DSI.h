...
#define DSI_API_MINOR_VERSION 9  /*     values, to find out the version of the API that */
...
DSI_API_FUNC(  int            ,    DSI_Headset_GetNumberOfChannels               ,  ( DSI_Headset h )                                                        ,   RETURN( 0, HEADSET->Montage()->size() )                                                                        )
DSI_API_FUNC(  int            ,    DSI_Headset_GetNumberOfSources                ,  ( DSI_Headset h )                                                        ,   RETURN( 0, HEADSET->Sources( false )->size() )                                                                 )
